	...
	@Test public void invalidSyntaxTests() {
		...
		for(int i=0;i!=inputs.length;++i) {
			...
			try {
				...
				fail("Exception occurred on: " + i + " "+ e.getMessage() + "\n");
				e.printStackTrace();
			}
		}				
	}	

	@Test public void additionalInvalidTests() {
